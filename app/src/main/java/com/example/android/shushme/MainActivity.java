...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch aSwitch = (Switch) findViewById(R.id.enable_switch);
        isGeofenceEnabled = getPreferences(MODE_PRIVATE).getBoolean(getString(R.string.setting_enabled),false);
        ...
        aSwitch.setChecked(isGeofenceEnabled);
        aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                SharedPreferences.Editor editor = getPreferences(MODE_PRIVATE).edit();
                editor.putBoolean(getResources().getString(R.string.setting_enabled, isChecked),false);
    ...
    public void refreshPlacesData() {
        ...
        placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
            ...
            public void onResult(@NonNull PlaceBuffer places) {
                ...
                if (isGeofenceEnabled) mGeoFencing.registerAllGeofences();
            }
        });
