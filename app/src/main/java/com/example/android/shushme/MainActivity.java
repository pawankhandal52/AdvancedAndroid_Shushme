...
public class MainActivity extends AppCompatActivity implements
    ...
    private void refreshPlacesData(){
        ...
        Log.i(TAG, "refreshPlacesData: Content uri "+uri);
        ...
        while(data.moveToNext()){
            guide.add(data.getString(data.getColumnIndex(PlaceContract.PlaceEntry.COLUMN_PLACE_ID)));
        }
    
        PendingResult<PlaceBuffer> placeBufferPendingResult = Places.GeoDataApi.getPlaceById(client,
                guide.toArray(new String[guide.size()]));
